...
'''	
	class for crawling user list by user_following.txt 
	where store the relationship between user and thier following
	and store the result to file user.txt
'''
class FollowingUserSpider(scrapy.spiders.Spider):
    name = "following_user"
